...
export default function LeaderboardRow({ entry, rank }: LeaderboardRowProps) {
  return (
    <div className="flex items-center justify-between rounded-2xl border border-ink/10 bg-white/70 p-4 shadow-soft dark:border-slate-700/60 dark:bg-slate-900/70">
      <div className="flex items-center gap-4">
        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-ink text-paper dark:bg-slate-100 dark:text-slate-900">
